...
from ur5.envs.env_box_v0 import BoxManipulation
from ur5.envs.env_cubes_test3 import CubesManipulation
import gymnasium as gym

from tests.action_sac3 import ActionSAC, ActionSACPolicy
...
n_actions = 2
policy_kwargs = dict(
	net_arch=dict(pi=[action_space_dim], qf=[256, 256]),
    action_config=dict(n_actions=n_actions, n_action_outputs=action_space_dim-n_actions, hidden_dim=256),
)
